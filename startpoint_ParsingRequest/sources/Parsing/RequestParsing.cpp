#include "../../includes/Parsing/RequestParsing.hpp"
...
{
	// first char that is not one from the given list
	size_t start = str.find_first_not_of(" \t\r\n");

	// last char that is not one from the given list
...
*/
std::vector<std::string> RequestParsing::split(const std::string &str,
	char limit) const
{
